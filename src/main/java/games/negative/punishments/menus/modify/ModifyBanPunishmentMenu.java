...
public class ModifyBanPunishmentMenu extends GUI {
    public ModifyBanPunishmentMenu(PersistentPunishment punishment) {
        ...
        ItemStack unPunish = new ItemBuilder(Material.BARRIER).setName("&c&lUnban User").build();
        setItemClickEvent(13, player -> unPunish, (player, event) -> {
            ...
            player.performCommand("unban " + offlinePlayer.getName());
        });
